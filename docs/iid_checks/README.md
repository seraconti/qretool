...
calibration study in `bench/`. When the licence wiring is decided, the durable parts fold
...
`bench/` measures empirical size and power at the event counts this project actually has,
...
- `bench/` - the calibration study; `bench/results/promotion_report.md` is its output
