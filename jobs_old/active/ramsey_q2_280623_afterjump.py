...
job = Job('ramsey_q2_280623_afterjump')
main_ds = Dataset(
    path='tool/datasets/6D2S/280623_6D2S_qubit2_after.pickle',
    schema=track912Schema,
    qubit=2,
    device='6D2S',
    duration_h=6,
    extra={"run_name": 'q2_12h_2806_dataset_afterjump'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q2_12h_2806_dataset_afterjump',
)
...
job.figure(
    ...
    title="q2_12h_2806_dataset_afterjump_t2star",
)
