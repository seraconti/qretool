...
job = Job('ramsey_q1_280623')
main_ds = Dataset(
    path='tool/datasets/6D2S/280623_6D2S_qubit1.pickle',
    schema=track912Schema,
    qubit=1,
    device='6D2S',
    duration_h=12,
    extra={"run_name": 'q1_12h_2806_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q1_12h_2806_dataset',
)
...
job.figure(
    ...
    title="q1_12h_2806_dataset_t2star",
)
