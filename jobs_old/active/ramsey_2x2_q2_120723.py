...
job = Job('ramsey_2x2_q2_120723')
configure_ramsey_job(
    job,
    Dataset(
        path='tool/datasets/2x2/120723_2x2_qubit2.pickle',
        schema=track912Schema,
        qubit=2,
        device='2x2',
        duration_h=15,
        extra={"run_name": 'q2_2x2_15h_1207_dataset'},
    ),
    profile='overnight',
    include_fidelity=False,
    figure_prefix='q2_2x2_15h_1207_dataset',
)
