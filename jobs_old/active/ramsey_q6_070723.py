...
job = Job('ramsey_q6_070723')
main_ds = Dataset(
    path='tool/datasets/6D2S/070723_6D2S_qubit6.pickle',
    schema=track912Schema,
    qubit=6,
    device='6D2S',
    duration_h=100,
    extra={"run_name": 'q6_100h_0707_dataset'},
)
comp_ds = Dataset(path='FOR ZENODO/Main/Fig 2/qubit6.pickle', schema=None)
...
configure_ramsey_job(
    ...
    figure_prefix='q6_100h_0707_dataset',
)
...
job.figure(
    ...
    title="q6_100h_0707_dataset_t2star",
)
