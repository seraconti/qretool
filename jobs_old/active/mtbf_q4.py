...
ds = Dataset(
    path="FOR ZENODO/Supplementary/Sup fig 1/6D2S/6D2S_qubit4_freq_log.pickle",
    schema=CalibrationLogSchema,
    qubit=4,
    device="6D2S",
    extra={"run_name": "mtbf_q4"},
)
...
job.figure(RepairablePanel, panel_data, targets=["static", "academic"], title="mtbf_q4")
