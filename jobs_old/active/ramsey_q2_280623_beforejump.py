...
job = Job('ramsey_q2_280623_beforejump')
main_ds = Dataset(
    path='tool/datasets/6D2S/280623_6D2S_qubit2_before.pickle',
    schema=track912Schema,
    qubit=2,
    device='6D2S',
    duration_h=7,
    extra={"run_name": 'q2_12h_2806_dataset_beforejump'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q2_12h_2806_dataset_beforejump',
)
...
job.figure(
    ...
    title="q2_12h_2806_dataset_beforejump_t2star",
)
