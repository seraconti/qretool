...
job = Job('ramsey_q3_110723')
main_ds = Dataset(
    path='tool/datasets/6D2S/110723_6D2S_qubit3.pickle',
    schema=track912Schema,
    qubit=3,
    device='6D2S',
    duration_h=15,
    extra={"run_name": 'q3_15h_1107_dataset'},
)
comp_ds = Dataset(path='FOR ZENODO/Main/Fig 2/qubit3.pickle', schema=None)
...
configure_ramsey_job(
    ...
    figure_prefix='q3_15h_1107_dataset',
)
...
job.figure(
    ...
    title="q3_15h_1107_dataset_t2star",
)
