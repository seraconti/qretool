...
job = Job('ramsey_q6_090623')
main_ds = Dataset(
    path='tool/datasets/6D2S/090623_6D2S_qubit6.pickle',
    schema=track912Schema,
    qubit=6,
    device='6D2S',
    duration_h=39,
    extra={"run_name": 'q6_39h_0906_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q6_39h_0906_dataset',
)
...
job.figure(
    ...
    title="q6_39h_0906_dataset_t2star",
)
