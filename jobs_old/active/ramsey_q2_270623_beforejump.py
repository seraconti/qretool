...
job = Job('ramsey_q2_270623_beforejump')
main_ds = Dataset(
    path='tool/datasets/6D2S/270623_6D2S_qubit2_before.pickle',
    schema=track912Schema,
    qubit=2,
    device='6D2S',
    duration_h=8,
    extra={"run_name": 'q2_16h_2706_dataset_beforejump'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q2_16h_2706_dataset_beforejump',
)
...
job.figure(
    ...
    title="q2_16h_2706_dataset_beforejump_t2star",
)
