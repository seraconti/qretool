...
job = Job('ramsey_q6_120423')
main_ds = Dataset(
    path='tool/datasets/6D2S/120423_6D2S_qubit6.pickle',
    schema=track912Schema,
    qubit=6,
    device='6D2S',
    duration_h=12,
    extra={"run_name": 'q6_12h_1204_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q6_12h_1204_dataset',
)
...
job.figure(
    ...
    title="q6_12h_1204_dataset_t2star",
)
