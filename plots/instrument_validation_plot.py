    ...
    def build_matplotlib(self, result: object, style: str = "default") -> plt.Figure:
        ...
        with theme.style_context(style):
            ...
            for i, n in enumerate(n_values):
                ...
                x = sub["pos"]
                ax_p.plot(x, sub["p_signed_diff_mean"], marker="o", color=color,
                          label=f"n = {int(n)}")
                ax_p.fill_between(
                    x,
                ...
                ax_size.plot(x, sub["type_i_closed"], marker="o", color=color,
                             label=f"n = {int(n)} closed form")
                ax_size.plot(x, sub["type_i_perm"], marker="s", linestyle=":",
                             color=color, alpha=0.65)
                ax_break.plot(x, sub["xi_tie_break_sd"], marker="o", color=color,
                              label=f"n = {int(n)}")
            ...
            ax_p.text(
                ...
                transform=ax_p.transAxes, **theme.ANNOTATION,
            )
            ...
            ax_size.text(
                ...
                "dashed: nominal 0.05.",
                transform=ax_size.transAxes, **theme.ANNOTATION,
            )
            ...
            ax_break.text(
                ...
                transform=ax_break.transAxes, **theme.ANNOTATION,
            )
