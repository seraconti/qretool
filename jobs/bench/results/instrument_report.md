...
|---|---|---|---|
| C1 Lewis-Robinson | partial - 4 of 7 published quantities exact; 3 differ by the 1/N vs 1/(N-1) divisor | partial - size measured at tau=20: 0.0708 +/- 0.0074 on exponential gaps (nominal 0.05). The bench measures 0.0640 and 0.0740 on Weibull shapes 0.75 and 1.50 - but ONLY in the fully specified cell arm=A_iid_weibull, clock=in_spec, quantised=False, censoring=0.00; ten rows share n=20/asymptotic/shape=0.75 and span 0.063 to 0.176. The DIRECTION depends on the gap distribution, so none is claimed | absent - no independent implementation in hand |
| C2 Anderson-Darling | pass - four published critical values reproduced | partial - size measured at tau=20: 0.0700 +/- 0.0074 on exponential gaps. Bench 0.0650 and 0.0865 on Weibull shapes 0.75 and 1.50, in the cell arm=A_iid_weibull, clock=in_spec, quantised=False, censoring=0.00 only - other rows at n=20 and the same shape run to 0.176 | partial - gamma=1 path equals `_classical_ad` to float precision - but that is five hand-written lines in our own test file, same language and same author, so it is tier-1 evidence wearing a tier-4 label. No independent implementation of eq (7) is in hand |
