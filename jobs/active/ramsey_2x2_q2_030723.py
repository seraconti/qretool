...
job = Job('ramsey_2x2_q2_030723')
configure_ramsey_job(
    job,
    Dataset(
        path='tool/datasets/2x2/030723_2x2_qubit2.pickle',
        schema=track912Schema,
        qubit=2,
        device='2x2',
        duration_h=16,
        extra={"run_name": 'q2_2x2_16h_0307_dataset'},
    ),
    profile='overnight',
    plot_mode='dedicated',
    include_fidelity=False,
    figure_prefix='q2_2x2_16h_0307_dataset',
)
