...
job = Job('ramsey_q1_040423')
main_ds = Dataset(
    path='tool/datasets/6D2S/040423_6D2S_qubit1.pickle',
    schema=track912Schema,
    qubit=1,
    device='6D2S',
    duration_h=10,
    extra={"run_name": 'q1_10h_0404_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q1_10h_0404_dataset',
)
...
job.figure(
    ...
    title="q1_10h_0404_dataset_t2star",
)
