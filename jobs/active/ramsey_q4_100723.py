...
job = Job('ramsey_q4_100723')
main_ds = Dataset(
    path='tool/datasets/6D2S/100723_6D2S_qubit4.pickle',
    schema=track912Schema,
    qubit=4,
    device='6D2S',
    duration_h=100,
    extra={"run_name": 'q4_100h_1007_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q4_100h_1007_dataset',
)
...
job.figure(
    ...
    title="q4_100h_1007_dataset_t2star",
)
