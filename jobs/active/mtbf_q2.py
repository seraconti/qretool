...
ds = Dataset(
    path="FOR ZENODO/Supplementary/Sup fig 1/6D2S/6D2S_qubit2_freq_log.pickle",
    schema=CalibrationLogSchema,
    qubit=2,
    device="6D2S",
    extra={"run_name": "mtbf_q2"},
)
...
job.figure(RepairablePanel, panel_data, targets=["static", "academic"], title="mtbf_q2")
