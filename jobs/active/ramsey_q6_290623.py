...
job = Job('ramsey_q6_290623')
main_ds = Dataset(
    path='tool/datasets/6D2S/290623_6D2S_qubit6.pickle',
    schema=track912Schema,
    qubit=6,
    device='6D2S',
    duration_h=13,
    extra={"run_name": 'q6_13h_2906_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q6_13h_2906_dataset',
)
...
job.figure(
    ...
    title="q6_13h_2906_dataset_t2star",
)
