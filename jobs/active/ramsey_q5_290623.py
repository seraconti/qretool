...
job = Job('ramsey_q5_290623')
main_ds = Dataset(
    path='tool/datasets/6D2S/290623_6D2S_qubit5.pickle',
    schema=track912Schema,
    qubit=5,
    device='6D2S',
    duration_h=13,
    extra={"run_name": 'q5_13h_2906_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q5_13h_2906_dataset',
)
...
job.figure(
    ...
    title="q5_13h_2906_dataset_t2star",
)
