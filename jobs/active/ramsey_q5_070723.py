...
job = Job('ramsey_q5_070723')
main_ds = Dataset(
    path='tool/datasets/6D2S/070723_6D2S_qubit5.pickle',
    schema=track912Schema,
    qubit=5,
    device='6D2S',
    duration_h=100,
    extra={"run_name": 'q5_100h_0707_dataset'},
)
comp_ds = Dataset(path='FOR ZENODO/Main/Fig 2/qubit5.pickle', schema=None)
...
configure_ramsey_job(
    ...
    figure_prefix='q5_100h_0707_dataset',
)
...
job.figure(
    ...
    title="q5_100h_0707_dataset_t2star",
)
