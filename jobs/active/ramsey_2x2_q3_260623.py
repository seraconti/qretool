...
job = Job('ramsey_2x2_q3_260623')
configure_ramsey_job(
    job,
    Dataset(
        path='tool/datasets/2x2/260623_2x2_qubit3.pickle',
        schema=track912Schema,
        qubit=3,
        device='2x2',
        duration_h=14,
        extra={"run_name": 'q3_2x2_14h_2606_dataset'},
    ),
    profile='overnight',
    plot_mode='dedicated',
    include_fidelity=False,
    figure_prefix='q3_2x2_14h_2606_dataset',
)
