...
job = Job('ramsey_q6_070623')
main_ds = Dataset(
    path='tool/datasets/6D2S/070623_6D2S_qubit6.pickle',
    schema=track912Schema,
    qubit=6,
    device='6D2S',
    duration_h=18,
    extra={"run_name": 'q6_18h_0706_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q6_18h_0706_dataset',
)
...
job.figure(
    ...
    title="q6_18h_0706_dataset_t2star",
)
