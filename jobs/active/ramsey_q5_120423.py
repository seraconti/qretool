...
job = Job('ramsey_q5_120423')
main_ds = Dataset(
    path='tool/datasets/6D2S/120423_6D2S_qubit5.pickle',
    schema=track912Schema,
    qubit=5,
    device='6D2S',
    duration_h=14,
    extra={"run_name": 'q5_14h_1204_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q5_14h_1204_dataset',
)
...
job.figure(
    ...
    title="q5_14h_1204_dataset_t2star",
)
