...
job = Job('ramsey_q5_070623')
main_ds = Dataset(
    path='tool/datasets/6D2S/070623_6D2S_qubit5.pickle',
    schema=track912Schema,
    qubit=5,
    device='6D2S',
    duration_h=18,
    extra={"run_name": 'q5_18h_0706_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q5_18h_0706_dataset',
)
...
job.figure(
    ...
    title="q5_18h_0706_dataset_t2star",
)
