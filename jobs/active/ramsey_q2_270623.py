...
job = Job('ramsey_q2_270623')
main_ds = Dataset(
    path='tool/datasets/6D2S/270623_6D2S_qubit2.pickle',
    schema=track912Schema,
    qubit=2,
    device='6D2S',
    duration_h=16,
    extra={"run_name": 'q2_16h_2706_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q2_16h_2706_dataset',
)
...
job.figure(
    ...
    title="q2_16h_2706_dataset_t2star",
)
