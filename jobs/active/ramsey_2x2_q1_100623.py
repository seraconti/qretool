...
job = Job('ramsey_2x2_q1_100623')
configure_ramsey_job(
    job,
    Dataset(
        path='tool/datasets/2x2/100623_2x2_qubit1.pickle',
        schema=track912Schema,
        qubit=1,
        device='2x2',
        duration_h=15,
        extra={"run_name": 'q1_2x2_15h_1006_dataset'},
    ),
    profile='overnight',
    include_fidelity=False,
    figure_prefix='q1_2x2_15h_1006_dataset',
)
