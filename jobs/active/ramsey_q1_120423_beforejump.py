...
job = Job('ramsey_q1_120423_beforejump')
main_ds = Dataset(
    path='tool/datasets/6D2S/120423_6D2S_qubit1_before.pickle',
    schema=track912Schema,
    qubit=1,
    device='6D2S',
    duration_h=10,
    extra={"run_name": 'q1_14h_1204_dataset_beforejump'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q1_14h_1204_dataset_beforejump',
)
...
job.figure(
    ...
    title="q1_14h_1204_dataset_beforejump_t2star",
)
