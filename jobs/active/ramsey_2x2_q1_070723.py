...
job = Job('ramsey_2x2_q1_070723')
configure_ramsey_job(
    job,
    Dataset(
        path='tool/datasets/2x2/070723_2x2_qubit1.pickle',
        schema=track912Schema,
        qubit=1,
        device='2x2',
        duration_h=24,
        extra={"run_name": 'q1_2x2_24h_0707_dataset'},
    ),
    profile='overnight',
    plot_mode='dedicated',
    include_fidelity=False,
    figure_prefix='q1_2x2_24h_0707_dataset',
)
