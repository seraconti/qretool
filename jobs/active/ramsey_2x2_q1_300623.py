...
job = Job('ramsey_2x2_q1_300623')
configure_ramsey_job(
    job,
    Dataset(
        path='tool/datasets/2x2/300623_2x2_qubit1.pickle',
        schema=track912Schema,
        qubit=1,
        device='2x2',
        duration_h=16,
        extra={"run_name": 'q1_2x2_16h_3006_dataset'},
    ),
    profile='overnight',
    plot_mode='dedicated',
    include_fidelity=False,
    figure_prefix='q1_2x2_16h_3006_dataset',
)
