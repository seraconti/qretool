...
job = Job('ramsey_q1_210423')
main_ds = Dataset(
    path='tool/datasets/6D2S/210423_6D2S_qubit1.pickle',
    schema=track912Schema,
    qubit=1,
    device='6D2S',
    duration_h=14,
    extra={"run_name": 'q1_14h_2104_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q1_14h_2104_dataset',
)
...
job.figure(
    ...
    title="q1_14h_2104_dataset_t2star",
)
