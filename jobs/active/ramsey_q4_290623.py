...
job = Job('ramsey_q4_290623')
main_ds = Dataset(
    path='tool/datasets/6D2S/290623_6D2S_qubit4.pickle',
    schema=track912Schema,
    qubit=4,
    device='6D2S',
    duration_h=13,
    extra={"run_name": 'q4_13h_2906_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q4_13h_2906_dataset',
)
...
job.figure(
    ...
    title="q4_13h_2906_dataset_t2star",
)
