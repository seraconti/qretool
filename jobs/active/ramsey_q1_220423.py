...
job = Job('ramsey_q1_220423')
main_ds = Dataset(
    path='tool/datasets/6D2S/220423_6D2S_qubit1.pickle',
    schema=track912Schema,
    qubit=1,
    device='6D2S',
    duration_h=41,
    extra={"run_name": 'q1_41h_2204_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q1_41h_2204_dataset',
)
...
job.figure(
    ...
    title="q1_41h_2204_dataset_t2star",
)
