...
job = Job('ramsey_q6_080623')
main_ds = Dataset(
    path='tool/datasets/6D2S/080623_6D2S_qubit6.pickle',
    schema=track912Schema,
    qubit=6,
    device='6D2S',
    duration_h=14,
    extra={"run_name": 'q6_14h_0806_dataset'},
)
...
configure_ramsey_job(
    ...
    figure_prefix='q6_14h_0806_dataset',
)
...
job.figure(
    ...
    title="q6_14h_0806_dataset_t2star",
)
