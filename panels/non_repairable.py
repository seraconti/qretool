...
Two halves:
  - NonRepairablePanelData is the COMPLETE typed artifact, composed of three bands
...
from analyzers.reliability_band import estimator_name
from analyzers.windows import STATE_UNOBSERVED
...
class NonRepairablePanel(BasePlot):
    ...
    Pure renderer over a complete NonRepairablePanelData. Three bands as rows:
    ...
    def _draw_shape(self, ax: plt.Axes, pd_: NonRepairablePanelData) -> None:
